Ext.define('Gw.override.grid.column.Column', {
  ...
  _renderRegularContent: function(column, value, store, record, rowIndex, colIndex, fieldName, metaData, skipFurtherRendering, view, outerIndex) {
    ...
    if (Ext.isArray(value)) {
      ...
      // PLWEB-4287: invalidFormat is set if there was an inputMask validation error
      else if (value && value.invalidFormat) {
        metaData.tdCls += ' g-invalid-cell';
      }
      ...
      //PLWEB-5500 Cell value populated from post on change while other column values are non-editable
