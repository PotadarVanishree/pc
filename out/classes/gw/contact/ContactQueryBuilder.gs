...
class ContactQueryBuilder extends EntityQueryBuilder<Contact> {
  ...
  function withFirstNameKanji(value: String) : ContactQueryBuilder {
    return withFirstNameKanjiRestricted(value, EqualsIgnoringCase)
  }

  function withFirstNameKanjiStarting(value: String) : ContactQueryBuilder {
    return withFirstNameKanjiRestricted(value, StartsWithIgnoringCase)
  }

  function withFirstNameKanjiRestricted(value: String, restrictor: StringColumnRestrictor) : ContactQueryBuilder {
  ...
  function withLastNameKanji(value : String) : ContactQueryBuilder {
    return withLastNameKanjiRestricted(value, EqualsIgnoringCase)
  }

  function withLastNameKanjiStarting(value : String) : ContactQueryBuilder {
    return withLastNameKanjiRestricted(value, StartsWithIgnoringCase)
  }
  ...
  function withCompanyNameKanji(value: String) : ContactQueryBuilder {
    return withCompanyNameKanjiRestricted(value, EqualsIgnoringCase)
  }

  function withCompanyNameKanjiStarting(value: String) : ContactQueryBuilder {
    return withCompanyNameKanjiRestricted(value, StartsWithIgnoringCase)
  }
  ...
  function withParticle(value: String) : ContactQueryBuilder {
    return withParticleRestricted(value, EqualsIgnoringCase)
  }

  function withParticleStarting(value: String) : ContactQueryBuilder {
  ...
  function withCityDenorm(value : String) : ContactQueryBuilder {
    return withCityDenormRestricted(value, EqualsIgnoringCase)
  }

  function withCityDenormStarting(value : String) : ContactQueryBuilder {
    return withCityDenormRestricted(value, StartsWithIgnoringCase)
  }
  ...
  function withCityKanjiDenorm(value : String) : ContactQueryBuilder {
    return withCityKanjiDenormRestricted(value, EqualsIgnoringCase)
  }

  function withCityKanjiDenormStarting(value : String) : ContactQueryBuilder {
    return withCityKanjiDenormRestricted(value, StartsWithIgnoringCase)
  }
  ...
  function withPostalCodeDenorm(value : String) : ContactQueryBuilder {
    return withPostalCodeDenormRestricted(value, EqualsIgnoringCase)
  }

  function withPostalCodeDenormStarting(value : String) : ContactQueryBuilder {
    return withPostalCodeDenormRestricted(value, StartsWithIgnoringCase)
  }
    ...
    FirstOrLast(\ selectQueryBuilder, firstNameRestrictor, firstName, lastNameRestrictor, lastName -> {
      if (firstName.NotBlank and lastName.NotBlank) {
        selectQueryBuilder.or(\ restriction -> {
          firstNameRestrictor.restrict(restriction, Person#FirstName.PropertyInfo.Name, firstName)
          lastNameRestrictor.restrict(restriction, Person#LastName.PropertyInfo.Name, lastName)
        })
      } else {
