...
class RenewalProcess extends NewTermProcess {
  ...
  function canEscalate() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.JobEscalation)
  ...
  function canManuallyQuote() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.ManuallyQuote)
            .checkBranchNotLocked()
  ...
  function canIssueNow() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.ImmediateBind)
  ...
  function canPendingNonRenew() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.PendingNonRenew)
  ...
  function canPendingNotTaken() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.PendingNotTaken)
  ...
  function canPendingRenew() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.PendingRenew)
            .checkAdvancePermission()
            .checkPermission(Permissions.Renew)
            .checkBranchNotLocked()
            .checkQuoteIsValid()
  ...
  function canEditFromWorkflow() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.EditInWorkflow)
            .checkEditPermission()
            .checkBranchNotLocked()
  ...
  function canSendRenewalDocuments() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.SendRenewalDoc)
            .checkBranchNotLocked()
            .checkQuoteIsValid()
  ...
  function canIssueAutomatedRenewal() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.IssueRenewal)
            .checkBranchNotLocked()
            .checkQuoteIsValid()
  }
  ...
  protected function unconditionalIssueRenewal() {
    ...
    try {
      ...
      _branch.updateEstimatedPremium()
        ...
        startChecksFor(displaykey.Job.Process.Renewal.FinishRenewal).checkOnlyActivePeriod().assertOkay()
  ...
  function canSendNonRenewalDocuments() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.SendNonRenewalDoc)
            .checkBranchNotLocked()
  ...
  function canSendNonRenewal() : JobConditions {
    return startChecksFor(displaykey.Job.Process.Renewal.NonRenew)
            .checkBranchNotLocked()
            .checkStatus(TC_NONRENEWING)
