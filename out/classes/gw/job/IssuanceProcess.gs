...
class IssuanceProcess extends JobProcess {
  ...
  function finishIssuing() {
    ...
    startChecksFor(displaykey.Job.Process.Issuance.Issuing).checkNoActivePeriods().assertOkay()
  ...
  function failIssuing() {
    startChecksFor(displaykey.Job.Process.Issuance.FailingIssuing).checkBranchNotLocked().assertOkay()
