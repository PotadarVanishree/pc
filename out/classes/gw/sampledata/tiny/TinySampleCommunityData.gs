...
class TinySampleCommunityData extends AbstractSampleDataCollection
{
  ...
  public override function load() {
    Transaction.runWithNewBundle( \bundle ->  {
      ...
      var westRgnGrp = loadGroup(bundle, "Western Region", enigmaOrg.RootGroup, "region", "HO UW", svisor, new User[] { iadmin, svisor, iportal, dpofficer }, "", enigmaOrg, "Western Region")
