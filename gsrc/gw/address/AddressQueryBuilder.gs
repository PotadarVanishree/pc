...
/**
 * AddressQueryBuilder is a class that builds queries for Address.
 */
@Export
class AddressQueryBuilder extends EntityQueryBuilder<Address> {
  ...
  function withAddressLine1(value : String) : AddressQueryBuilder {
    return withAddressLine1Restricted(value, EqualsIgnoringCase)
  }
  ...
  function withAddressLine1Kanji(value: String) : AddressQueryBuilder {
    return withAddressLine1KanjiRestricted(value, EqualsIgnoringCase)
  }

  function withAddressLine1KanjiStarting(value: String) : AddressQueryBuilder {
    return withAddressLine1KanjiRestricted(value, StartsWithIgnoringCase)
  }
  ...
  function withAddressLine1KanjiRestricted(value : String, restrictor : StringColumnRestrictor) : AddressQueryBuilder {
    ...
    _addressLine1KanjiRestrictor = restrictor
    return this
  }

  function withAddressLine2(value : String) : AddressQueryBuilder {
    return withAddressLine2Restricted(value, EqualsIgnoringCase)
  }
  ...
  function withAddressLine2Kanji(value: String) : AddressQueryBuilder {
    return withAddressLine2KanjiRestricted(value, EqualsIgnoringCase)
  }

  function withAddressLine2KanjiStarting(value: String) : AddressQueryBuilder {
    return withAddressLine2KanjiRestricted(value, StartsWithIgnoringCase)
  }
  ...
  function withCityKanji(value : String) : AddressQueryBuilder {
    return withCityKanjiRestricted(value, EqualsIgnoringCase)
  }

  function withCityKanjiStarting(value : String) : AddressQueryBuilder {
    return withCityKanjiRestricted(value, StartsWithIgnoringCase)
  }
  ...
  override function doRestrictQuery(selectQueryBuilder : ISelectQueryBuilder) {
    ...
    if (_addressLine1Kanji.NotBlank) {
      _addressLine1KanjiRestrictor.restrict(selectQueryBuilder, "AddressLine1Kanji", _addressLine1Kanji)
    }
